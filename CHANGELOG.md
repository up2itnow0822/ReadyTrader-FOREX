...
- **Tests**: 52 new tests (the four that pinned the volatility stub now pin the implementation), including real-bar fixtures (the SNB day from both legs, the 2021 lira collapse, the 2016 GBP flash crash) whose expectations come from the independent research code.
